...
public:
    ...
    void displayInfo(const int personID)
    {
        ...
        for (int pos = 0; pos < personIds.size(); pos++)
        {
            ...
            {
                if (bookIds[pos] != "-1")
                    books.push_back(bookIds[pos]);
                if (eBookIds[pos] != "-1")
                    eBooks.push_back(eBookIds[pos]);
            }
        }
...
public:
    ...
    void Register(Person &p)
    {
        ...
        {
            personFile << endl
                       << "[" + to_string(personID) + "] [" + fullName + "] [" + email + "] [" + gender + "] [" + birthdate + "] [" + address + "] [" + phoneNumber + "] [User]";
            ;
            personFile.close();
        }
        else
        ...
        {
            userFile << endl
                     << "[" + to_string(userID) + "] [" + email + "] [" + password + "]";
            userFile.close();
